...
export function ProfileSettingsScreen() {
  ...
  const handleChangePassword = async () => {
    ...
    setIsSaving(true);
    try {
      const result = await authApi.changePassword(user.email, currentPassword, newPassword, confirmPassword);
      if (result.error) {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]} contentContainerStyle={styles.content}>
      ...
      <Card>
        ...
        <Input label="Confirm New Password" value={confirmPassword} onChangeText={setConfirmPassword} placeholder="Re-enter new password" secureTextEntry />
