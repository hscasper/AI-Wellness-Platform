  ...
  return (
    ...
    >
      {!hasExisting && (
        <Banner
          variant="info"
          message="No notification preferences set yet. Configure your daily tips below."
        />
      )}
      ...
      <Card style={[{ marginBottom: 16 }, !isEnabled && { opacity: 0.5 }]}>
        ...
        <View style={styles.timePicker}>
          ...
          <View style={{ alignItems: 'center' }}>
            ...
            <Text style={[fonts.caption, { color: colors.textLight, marginTop: 2 }]}>
              {preferredTime}
            </Text>
          </View>
          <TouchableOpacity
      ...
      <Card style={[{ marginBottom: 16 }, !isEnabled && { opacity: 0.5 }]}>
        ...
        <View style={[styles.tzRow, { backgroundColor: colors.background }]}>
          ...
          <Text
            style={[
              fonts.body,
              { color: isEnabled ? colors.text : colors.disabled, fontWeight: '500' },
            ]}
          >
            {timezone}
          </Text>
