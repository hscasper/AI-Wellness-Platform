    ...
    >
      <Card style={styles.resultCard}>
        ...
        <View style={[styles.severityBadge, { backgroundColor: `${colors.primary}12` }]}>
          <Text style={[fonts.heading3, { color: colors.text }]}>{result.severityLabel}</Text>
        </View>
      </Card>
      ...
      <Card style={styles.interpretationCard}>
        <View style={styles.interpretationHeader}>
          ...
          <Text style={[fonts.heading3, { color: colors.text }]}>What This Means</Text>
        </View>
      ...
      <Banner type="warning" message={CLINICAL_DISCLAIMER} icon="medical-outline" />
