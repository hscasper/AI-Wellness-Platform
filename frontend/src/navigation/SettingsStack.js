...
export function SettingsStack() {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="ExportData" component={ExportScreen} options={{ title: "Export for Therapist" }} />
      <Stack.Screen name="WearableSettings" component={WearableSettingsScreen} options={{ title: "Health Data" }} />
      <Stack.Screen name="ProfessionalDirectory" component={ProfessionalDirectoryScreen} options={{ title: "Find a Professional" }} />
    </Stack.Navigator>
  );
}
