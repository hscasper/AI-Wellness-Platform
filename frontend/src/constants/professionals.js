...
export const PROFESSIONALS = [
  {
    ...
    description: "Nation-wide community mental health services including counseling, support groups, and crisis intervention.",
  },
  {
    id: "2",
    ...
    description: "Licensed therapists available online. Convenient for students with flexible scheduling.",
  },
  {
    id: "3",
    ...
    description: "Searchable directory of licensed therapists in Canada with filters for specialty, insurance, and location.",
  },
  {
    id: "4",
  ...
  },
  {
    ...
    description: "24/7 support for Indigenous peoples in Canada. Available in English, French, Cree, Ojibway, and Inuktitut.",
  },
  {
    id: "7",
    ...
    description: "Government-funded free mental health and substance use support. Phone, text, and online counseling.",
  },
];
